...
- d `takeScreenshot` from [executeActionById](Chart-Methods.md#executeactionbyidactionid) method is removed. Use [takeScreenshot](Widget-Methods#takescreenshot) method instead.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTQ2NzM1NjMwM119
-->