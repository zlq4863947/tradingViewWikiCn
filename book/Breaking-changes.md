...
- 动作 `takeScreenshot` 从 [executeActionById](Chart-Methods.md#executeactionbyidactionid) 方法中被删除 is removed. Use [takeScreenshot](Widget-Methods#takescreenshot) method instead.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTU4OTcxNzQ0NF19
-->