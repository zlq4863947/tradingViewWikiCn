...
* /charting\_library/charting\_library.min.js 包含外部图表库widget 接口。不建议修改该文件。*  `/charting_library/charting_library.min.d.ts` contains TypeScript definitions for the widget interface.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTM4Mzg3NjUxMCwtOTc4NDU2MDA1XX0=
-->